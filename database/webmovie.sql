...
--
-- Host: localhost    Database: webmovie
-- ------------------------------------------------------
...
CREATE TABLE `bookings` (
  ...
  `seat_location` varchar(255) DEFAULT NULL,
...
CREATE TABLE `showtimes` (
  ...
  CONSTRAINT `showtimes_ibfk_1` FOREIGN KEY (`schedule_id`) REFERENCES `schedules` (`id`),
  CONSTRAINT `showtimes_ibfk_2` FOREIGN KEY (`theater_id`) REFERENCES `theaters` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-08-15  9:09:50
